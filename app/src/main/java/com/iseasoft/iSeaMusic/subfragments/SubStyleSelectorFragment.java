...
public class SubStyleSelectorFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        switch (getArguments().getInt(ARG_PAGE_NUMBER)) {
            case 0:
                styleImage.setImageResource(R.drawable.iseamusic_1_nowplaying_x);
                break;
            case 1:
                styleImage.setImageResource(R.drawable.iseamusic_2_nowplaying_x);
                break;
            case 2:
                styleImage.setImageResource(R.drawable.iseamusic_3_nowplaying_x);
                break;
            case 3:
                styleImage.setImageResource(R.drawable.iseamusic_4_nowplaying_x);
                break;
            case 4:
                styleImage.setImageResource(R.drawable.iseamusic_5_nowplaying_x);
                break;
            case 5:
                styleImage.setImageResource(R.drawable.iseamusic_6_nowplaying_x);
                break;
        }
    ...
    public void setCurrentStyle() {
        String fragmentID = preferences.getString(Constants.NOWPLAYING_FRAGMENT_ID, Constants.ISEAMUSIC3);
    ...
    private String getStyleForPageNumber() {
        switch (getArguments().getInt(ARG_PAGE_NUMBER)) {
            case 0:
                return Constants.ISEAMUSIC1;
            case 1:
                return Constants.ISEAMUSIC2;
            case 2:
                return Constants.ISEAMUSIC3;
            case 3:
                return Constants.ISEAMUSIC4;
            case 4:
                return Constants.ISEAMUSIC5;
            case 5:
                return Constants.ISEAMUSIC6;
            default:
                return Constants.ISEAMUSIC3;
        }
    }
