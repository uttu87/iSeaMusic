...
import com.iseasoft.iSeaMusic.lastfmapi.models.LastfmUserSession;
import com.iseasoft.iSeaMusic.lastfmapi.models.ScrobbleQuery;
...
public class MusicService extends Service {
    ...
    public static final String QUEUE_CHANGED = "com.iseasoft.iSeaMusic.queuechanged";
    public static final String PLAYLIST_CHANGED = "com.iseasoft.iSeaMusic.playlistchanged";
    public static final String REPEATMODE_CHANGED = "com.iseasoft.iSeaMusic.repeatmodechanged";
    public static final String SHUFFLEMODE_CHANGED = "com.iseasoft.iSeaMusic.shufflemodechanged";
    public static final String TRACK_ERROR = "com.iseasoft.iSeaMusic.trackerror";
    public static final String ISEA_MUSIC_PACKAGE_NAME = "com.iseasoft.iSeaMusic";
    public static final String MUSIC_PACKAGE_NAME = "com.android.music";
    public static final String SERVICECMD = "com.iseasoft.iSeaMusic.musicservicecommand";
    public static final String TOGGLEPAUSE_ACTION = "com.iseasoft.iSeaMusic.togglepause";
    public static final String PAUSE_ACTION = "com.iseasoft.iSeaMusic.pause";
    public static final String STOP_ACTION = "com.iseasoft.iSeaMusic.stop";
    public static final String PREVIOUS_ACTION = "com.iseasoft.iSeaMusic.previous";
    public static final String PREVIOUS_FORCE_ACTION = "com.iseasoft.iSeaMusic.previous.force";
    public static final String NEXT_ACTION = "fcom.iseasoft.iSeaMusic.next";
    public static final String REPEAT_ACTION = "com.iseasoft.iSeaMusic.repeat";
    public static final String SHUFFLE_ACTION = "com.iseasoft.iSeaMusic.shuffle";
    public static final String FROM_MEDIA_BUTTON = "frommediabutton";
    public static final String REFRESH = "com.iseasoft.iSeaMusic.refresh";
    public static final String UPDATE_LOCKSCREEN = "com.iseasoft.iSeaMusic.updatelockscreen";
    ...
    public static final String CHANNEL_ID = "iseamusic_channel_01";
    ...
    private static final String SHUTDOWN = "com.iseasoft.iSeaMusic.shutdown";
    ...
    private void setUpMediaSession() {
        mSession = new MediaSessionCompat(this, "iSeaMusic");
    ...
    private void notifyChange(final String what) {
        ...
        musicIntent.setAction(what.replace(ISEA_MUSIC_PACKAGE_NAME, MUSIC_PACKAGE_NAME));
...
//            }
    ...
    private static final class ServiceStub extends iSeaMusicService.Stub {
