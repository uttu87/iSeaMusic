...
public class Constants {
    ...
    public static final String ISEAMUSIC1 = "iSeaMusic1";
    public static final String ISEAMUSIC2 = "iSeaMusic2";
    public static final String ISEAMUSIC3 = "iSeaMusic3";
    public static final String ISEAMUSIC4 = "iSeaMusic4";
    public static final String ISEAMUSIC5 = "iSeaMusic5";
    public static final String ISEAMUSIC6 = "iSeaMusic6";
