...
import com.iseasoft.iSeaMusic.activities.MainActivity;
import com.iseasoft.iSeaMusic.activities.NowPlayingActivity;
import com.iseasoft.iSeaMusic.activities.PlaylistDetailActivity;
import com.iseasoft.iSeaMusic.activities.SearchActivity;
...
import com.iseasoft.iSeaMusic.nowplaying.iSeaMusic1;
import com.iseasoft.iSeaMusic.nowplaying.iSeaMusic2;
import com.iseasoft.iSeaMusic.nowplaying.iSeaMusic3;
import com.iseasoft.iSeaMusic.nowplaying.iSeaMusic4;
import com.iseasoft.iSeaMusic.nowplaying.iSeaMusic5;
import com.iseasoft.iSeaMusic.nowplaying.iSeaMusic6;
...
public class NavigationUtils {
    ...
    public static Fragment getFragmentForNowplayingID(String fragmentID) {
        switch (fragmentID) {
            case Constants.ISEAMUSIC1:
                return new iSeaMusic1();
            case Constants.ISEAMUSIC2:
                return new iSeaMusic2();
            case Constants.ISEAMUSIC3:
                return new iSeaMusic3();
            case Constants.ISEAMUSIC4:
                return new iSeaMusic4();
            case Constants.ISEAMUSIC5:
                return new iSeaMusic5();
            case Constants.ISEAMUSIC6:
                return new iSeaMusic6();
            default:
                return new iSeaMusic1();
        }
