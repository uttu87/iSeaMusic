...
public class BaseQueueAdapter extends AdsAdapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_song_iseamusic1, null);
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        ...
                        switch (item.getItemId()) {
                            ...
                            case R.id.popup_song_delete:
                                ...
                                iSeaUtils.showDeleteDialog(mContext, song.title, deleteIds, BaseQueueAdapter.this, position);
                                break;
                        }
                        return false;
                    }
